    ...
    static createTypeOrmRootModules(
        ...
        return [
            TypeOrmModule.forRootAsync({
                ...
                useFactory: () => PgTypeConfigurer.createWriteTypeOrmOptions(entities),
            }),
            TypeOrmModule.forRootAsync({
                name: readConnectionName,
                useFactory: () => PgTypeConfigurer.createReadTypeOrmOptions(entities),
            }),
        ];
    }
}
