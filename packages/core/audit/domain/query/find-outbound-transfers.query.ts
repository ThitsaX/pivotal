...
export class FindOutboundTransfersQuery {
    constructor(public readonly input: FindOutboundTransfersQuery.Input) {
    }
}

export namespace FindOutboundTransfersQuery {
    ...
    export class Output {
        constructor(
            public readonly records: OutboundTransfers[],
