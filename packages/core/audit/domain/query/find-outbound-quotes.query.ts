...
export class FindOutboundQuotesQuery {
    constructor(public readonly input: FindOutboundQuotesQuery.Input) {
    }
}

export namespace FindOutboundQuotesQuery {
    ...
    export class Output {
        constructor(
            public readonly records: OutboundQuotes[],
