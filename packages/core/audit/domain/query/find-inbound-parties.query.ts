...
export class FindInboundPartiesQuery {
    constructor(public readonly input: FindInboundPartiesQuery.Input) {
    }
}

export namespace FindInboundPartiesQuery {
    ...
    export class Output {
        constructor(
            public readonly records: InboundParties[],
