...
@Entity({name: 'inbound_transfers_request'})
@Index('inbound_transfers_request_01_idx', ['correlationId'])
@Index('inbound_transfers_request_02_idx', ['transferId'])
@Index('inbound_transfers_request_03_idx', ['createdAt'])
@Index('inbound_transfers_request_04_idx', ['payerFsp', 'payeeFsp'])
@Index('inbound_transfers_request_05_idx', ['rail'])
export class InboundTransfersRequest {
