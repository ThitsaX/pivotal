...
@Entity({name: 'outbound_parties_request'})
@Index('outbound_parties_request_01_idx', ['correlationId'])
@Index('outbound_parties_request_02_idx', ['partyIdType', 'partyId'])
@Index('outbound_parties_request_03_idx', ['partyIdType', 'partyId', 'subId'])
@Index('outbound_parties_request_04_idx', ['createdAt'])
@Index('outbound_parties_request_05_idx', ['payerFsp', 'payeeFsp'])
@Index('outbound_parties_request_06_idx', ['rail'])
export class OutboundPartiesRequest {
