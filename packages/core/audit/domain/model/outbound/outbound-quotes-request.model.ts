...
@Entity({name: 'outbound_quotes_request'})
@Index('outbound_quotes_request_01_idx', ['correlationId'])
@Index('outbound_quotes_request_02_idx', ['quoteId'])
@Index('outbound_quotes_request_03_idx', ['createdAt'])
@Index('outbound_quotes_request_04_idx', ['payerFsp', 'payeeFsp'])
@Index('outbound_quotes_request_05_idx', ['rail'])
export class OutboundQuotesRequest {
