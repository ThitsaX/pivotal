...
@Index('inbound_parties_05_idx', ['completedAt'])
@Index('inbound_parties_06_idx', ['payerFsp', 'payeeFsp'])
@Index('inbound_parties_07_idx', ['rail'])
@Index('inbound_parties_08_idx', ['failed'])
