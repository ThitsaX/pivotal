...
@Index('outbound_transfers_01_idx', ['transferId'])
@Index('outbound_transfers_02_idx', ['createdAt'])
@Index('outbound_transfers_03_idx', ['completedAt'])
@Index('outbound_transfers_04_idx', ['payerFsp', 'payeeFsp'])
@Index('outbound_transfers_05_idx', ['rail'])
@Index('outbound_transfers_06_idx', ['failed'])
@Index('outbound_transfers_07_idx', ['correlationId'])
