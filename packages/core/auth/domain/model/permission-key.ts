...
export const PermissionKey = {
    ...
    PARTICIPANT_CERT_ENROLL:         'participant.certificate.enroll',
    PARTICIPANT_CERT_VIEW:           'participant.certificate.view',
    PARTICIPANT_CERT_REVOKE:         'participant.certificate.revoke',
