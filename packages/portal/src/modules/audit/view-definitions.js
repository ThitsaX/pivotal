...
const TRANSACTION_SCENARIO_OPTIONS = [
    { label: '(Any)', value: '' },
    ...Object.values(TransactionScenario).map((scenario) => ({
        label: scenario,
        value: scenario,
    })),
];
...
export const VIEW_BY_KEY = Object.fromEntries(VIEW_DEFINITIONS.map((view) => [view.key, view]));
