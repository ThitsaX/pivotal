...
import {ReportWorkerAppModule} from './app.module';

const ROOT_ENV_LOCATION = '.env';
const MODULE_ENV_LOCATION = 'packages/apps/report-worker/.env';
...
const bootstrap = async (): Promise<void> => {
    ...
    const app = await NestFactory.createApplicationContext(ReportWorkerAppModule);
    app.enableShutdownHooks();

    Logger.log('Report download worker started.', 'Bootstrap');
};
